...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `<img src="${games[i].img}" alt="${games[i].img}" class="game-img" /> 
        <h3>${games[i].name}</h3>
...
const displayStr = `A total of $${totalPledged.toLocaleString()} has been raised for ${totalGamesCount} games. 
Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains" : "games remain"} unfunded.
We need your help to fund these amazing ${unfundedGamesCount === 1 ? "game" : "games"}!`
...
secondGameElement.innerHTML = `${runnerUpGame.name}`;
